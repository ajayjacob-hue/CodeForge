            ...
            {status === 'loading' ? (
              ...
              <div className="flex items-center space-x-4">
                <div className="flex items-center space-x-2 px-3 py-1.5 rounded-full bg-slate-800 border border-slate-700">
                  ...
                  <span className="hidden sm:inline text-sm font-medium text-slate-200">{session.user?.name}</span>
                </div>
                <button 
              ...
              <div className="flex items-center space-x-3">
                <button 
                  ...
                  className="flex items-center px-3 py-2 text-sm font-medium text-slate-300 bg-slate-800 hover:bg-slate-700 rounded-lg transition-colors border border-slate-700"
                >
